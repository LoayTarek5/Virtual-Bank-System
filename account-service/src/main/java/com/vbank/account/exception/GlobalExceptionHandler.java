...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleSpringWeb(ErrorResponseException ex) {
        HttpStatus status = HttpStatus.valueOf(ex.getStatusCode().value());
        return build(status, Objects.requireNonNullElse(ex.getBody().getDetail(), status.getReasonPhrase()));
    }
